...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="<?php echo e(route("home")); ?>" class="navbar-brand mr-0">
            <i class="fa fa-fw fa-book"></i> Pagina Inicial
        </a>
...
<?php /**PATH C:\xampp\htdocs\SyncWeb\resources\views/vendor/log-viewer/bootstrap-4/_master.blade.php ENDPATH**/ ?>