<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent("layouts.componentes.box",["title"=>"Publicar Filmes","icon"=> "fas fa-film"]); ?>
        ...
        <div class="form-group">
            <?php $__env->startComponent("layouts.componentes.checkbox",["id"=>"is_cinema","name"=>"is_cinema"]); ?>
                IMAGEM DE CINEMA ?
            ...
            if (valor.length > 0) {
                if (valor !== link_inicial) {
                    ...
                    ({
                        type: "POST",
                        dataType: 'json',
                        url: "<?php echo e(route('filmes.pesquisa')); ?>",
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SyncWeb\resources\views/screens/movies/create-movies.blade.php ENDPATH**/ ?>