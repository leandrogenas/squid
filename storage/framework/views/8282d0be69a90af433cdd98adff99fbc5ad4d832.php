<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent("layouts.componentes.box",["title"=>"Publicar Jogos","icon"=> "fas fa-gamepad"]); ?>
        ...
        <div class="form-group">
            <?php $__env->startComponent("layouts.componentes.checkbox",["id"=>"cpt_br","name"=>"pt_br"]); ?>
                PT-BR ?
            <?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent("layouts.componentes.checkbox",["id"=>"no_torrent","name"=>"no_torrent"]); ?>
                SEM TORRENT ?
            <?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent("layouts.componentes.checkbox",["id"=>"todas_dlc","name"=>"todas_dlc"]); ?>
                TODAS DLC ?
            <?php echo $__env->renderComponent(); ?>
        </div>
        <hr>
        ...
        <div class="form-group">
            <?php echo e(html()->form("post",route("jogos.publicar"))->id("form-publica")->open()); ?>

            <div class="form-group">

                <input type="hidden" value="<?php echo e(\App\Enums\Sites::JOGOS_TORRENT); ?>" name="sites[]">
...
<?php $__env->startSection("js"); ?>
    <script>
        ...
        function enviar_dados() {
            $.post('<?php echo e(route("jogos.publicar")); ?>', $("#form-publica").serialize(), function (msg) {
                var erro = false;
                if (msg.msg === "sucesso") {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SyncWeb\resources\views/screens/games/create-games.blade.php ENDPATH**/ ?>