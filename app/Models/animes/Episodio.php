...
class Episodio
{
    ...
    public function preparaDados($em_caso_falha = false,$link_falha = "")
    {
        try {
            $this->log = "";
            $link_download = $em_caso_falha ? $link_falha:$this->link_download;
    ...
    private function tirar_print($time = "00:10:00", $imagem_url = "img/temp.png", $link_download = "")
    {
        ...
        //\Log::info("Resultado com o link: $link_download ".$resultado);
