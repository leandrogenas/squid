...
@section('content')
    @component("layouts.componentes.box",["title"=>"Publicar Séries (NOVO)","icon"=> "fas fa-video"])
            ...
            <div id="dados">
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            @component("layouts.componentes.painel-collapse",["title"=>"Opções"])
        ...
        <hr>
        <form id="form-publica" method="post" action="{{route("season.postar")}}">
            @csrf
            <div class="form-group">
...
@section("js")
    ...
    <script>
        ...
        function enviar_dados() {
            ...
            preparar_progresso();
            $.post('{{route("season.postar")}}', $("#form-publica").serialize(), function (msg) {
                var erro = false;
                Swal.close();
                if(msg.msg === "sucesso"){
        ...
        function pegar_progresso() {
            $.getJSON('{{route("season.progresso")}}', function (data) {
                let id = data[0];
                if(id !== 0){
